---
title: "STATS 266 Handout - Control Flow and Functions"
author: "Qi Wang"
date: "`r Sys.Date()`"
output: 
  pdf_document:
...
result
```
There are one more type of loop called ``repeat loop", however, that is not as widely use as for and while loop. If you are interested in them, refer to: https://www.datacamp.com/tutorial/tutorial-on-loops-in-r.
